...
namespace ShadowRunHelperViewer.Strings
{
    ...
    public class UiResourcesExtension : IMarkupExtension
    {
        readonly CultureInfo ci = null;
        const string ResourceId = nameof(ShadowRunHelperViewer) + "." + nameof(Strings) + "." + nameof(UiResources);

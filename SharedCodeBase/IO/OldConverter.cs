...
namespace ShadowRunHelper.IO
{
    ...
    {
        static void CopyAttribute(CharModel.Attribut Target, ShadowRunHelper1_3.CharModel.Attribut Source)
        {
        ...
        internal static CharHolder ConvertVersion1_3to1_5(ShadowRunHelper1_3.Controller.CharHolder cH1_3)
        {
            ...
            foreach (var item in cH1_3.AttributController)
            {
                ...
                {
                    AppModel.Instance.NewNotification(CrossPlatformHelper.GetString("Model_Attribut_/Text") +" "+ item.Data.Bezeichner+ " "+CrossPlatformHelper.GetString("Notification_Error_Converter_Error1/Text"));
                }
            }
            ...
            foreach (var item in cH1_3.HandlungController)
            {
                ...
                {
                    var t = ReturnCharHolder.LinkList.Find(x => x.Object.Bezeichner == zusitem.Value.Bezeichner);
                    if (t?.Object != null)
                    {
                    ...
                    {
                        AppModel.Instance.NewNotification(CrossPlatformHelper.GetString("Model_Handlung_/Text") + " " + item.Data.Bezeichner + " - " + CrossPlatformHelper.GetString("Model_Handlung_Zusammensetzung/Text") + zusitem.Value.Bezeichner + CrossPlatformHelper.GetString("Notification_Error_Converter_Error1/Text"));
                    }
                }
                foreach (var zusitem in item.Data.GegenZusammensetzung)
                {
                    ...
                    {
                        AppModel.Instance.NewNotification(CrossPlatformHelper.GetString("Model_Handlung_/Text") + " " + item.Data.Bezeichner + " - " + CrossPlatformHelper.GetString("Model_Handlung_GegenZusammensetzung/Text") + zusitem.Value.Bezeichner + CrossPlatformHelper.GetString("Notification_Error_Converter_Error1/Text"));
                    }
                }
                foreach (var zusitem in item.Data.GrenzeZusammensetzung)
                {
                    ...
                    {
                        AppModel.Instance.NewNotification(CrossPlatformHelper.GetString("Model_Handlung_/Text") + " " + item.Data.Bezeichner + " - " + CrossPlatformHelper.GetString("Model_Handlung_GrenzeZusammensetzung/Text") + zusitem.Value.Bezeichner + CrossPlatformHelper.GetString("Notification_Error_Converter_Error1/Text"));
                    }
                }
            }

...
namespace ShadowRunHelper1_3.IO
{
    class CharIO
    {
        internal static string Char_to_JSON(Controller.CharHolder SaveChar)
        {
        ...
        internal static Controller.CharHolder JSON_to_Char(string fileContent)
        {
            ...
            catch (Exception)
            {
                ...
                AppModel.Instance.NewNotification("Error at StartUp-Char-Loading");
            }

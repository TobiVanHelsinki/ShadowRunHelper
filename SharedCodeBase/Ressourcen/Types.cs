...
namespace ShadowRunHelper
{
    ...
    public static class TypeHelper
    {
        ...
        private static List<ThingTypeProperty> thingTypeProperties = new List<ThingTypeProperty>() {
           ...
           new ThingTypeProperty(typeof(Adeptenkraft_KomplexeForm),ThingDefs.Adeptenkraft, 0, 2, "Adeptenkraft"),
           new ThingTypeProperty(typeof(Foki_Widgets),ThingDefs.Foki, 1, 0, "Foki"),
           new ThingTypeProperty(typeof(Geist_Sprite),ThingDefs.Geist, 1, 0, "Geist"),
           new ThingTypeProperty(typeof(Stroemung_Wandlung),ThingDefs.Stroemung, 3, 0, "Stroemung"),
           new ThingTypeProperty(typeof(Tradition_Initiation),ThingDefs.Tradition, 3, 0, "Tradition"),

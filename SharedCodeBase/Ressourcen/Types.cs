...
namespace ShadowRunHelper
{
    ...
    public static class TypeHelper
    {
        ...
        private static List<ThingTypeProperty> thingTypeProperties = new List<ThingTypeProperty>() {
           ...
           new ThingTypeProperty(typeof(Adeptenkraft),ThingDefs.Adeptenkraft, 0, 2, "Adeptenkraft"),
           new ThingTypeProperty(typeof(Foki),ThingDefs.Foki, 1, 0, "Foki"),
           new ThingTypeProperty(typeof(Geist),ThingDefs.Geist, 1, 0, "Geist"),
           new ThingTypeProperty(typeof(Stroemung),ThingDefs.Stroemung, 3, 0, "Stroemung"),
           new ThingTypeProperty(typeof(Tradition),ThingDefs.Tradition, 3, 0, "Tradition"),

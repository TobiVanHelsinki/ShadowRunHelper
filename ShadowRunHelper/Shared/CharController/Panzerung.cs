...
namespace ShadowRunHelper.CharController
{
    public class cPanzerungController : cController<Panzerung>
    {
        ...
        public cPanzerungController()
        {
            ...
            MI_2 = new ThingListEntry(ActiveItem, res.GetString("Model_Panzerung_Kapazität/Text"), "Kapazität");
            MI_3 = new ThingListEntry(ActiveItem, res.GetString("Model_Panzerung_Stoß/Text"), "Stoß");

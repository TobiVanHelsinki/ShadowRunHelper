...
namespace ShadowRunHelper
{
    ...
    {
        internal static string msg = CustomManager.GetString("Notification_Error_IO_FileVersion");
    ...
    {
        internal static string msg = CustomManager.GetString("Notification_Error_IO_UserDecision");
    ...
    {
        internal static string msg = CustomManager.GetString("Notification_Error_IO_FolderNotFoundOrNotCreated");
    ...
    {
        internal static string msg = CustomManager.GetString("Notification_Error_AllListChooser");
    ...
    {
        internal static string msg = CustomManager.GetString("Notification_Error_IO_Deserialize");
    ...
    {
        internal static string msg = CustomManager.GetString("Notification_Error_Enum");
